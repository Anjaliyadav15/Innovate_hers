...
export default function ReportLostItem() {
  return (
    <div className="flex min-h-screen flex-col w-screen m-auto px-2 items-center">
        ...
        <div className="container max-w-3xl">
          ...
          <Card>
            <CardHeader className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <CardDescription>Fill out the form below with details about your lost item</CardDescription>
                </div>
              </div>
            </CardHeader>
            ...
            <CardFooter className="flex justify-between">
              ...
              <Button className="bg-red-500 hover:bg-red-600">Submit Lost Item Report</Button>
            </CardFooter>
          </Card>
        </div>
      </main>
